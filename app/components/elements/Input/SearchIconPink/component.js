...
import { COLOR_GREY_DARK, COLOR_GREY, COLOR_TRANSPARENT, COLOR_BASE_PRIMARY_MAIN } from '../../../../styles';
import { noop } from '../../../../utils';
import Searching from '../../../../../assets/svgs/Searching';
      ...
      <View style={styles.mainContainer}>
        <View style={containerTextInputStyle}>
          <View style={styles.containerIcon}>
            <Searching width={15} height={15} color={COLOR_BASE_PRIMARY_MAIN} />
          </View>
          <TextInput
